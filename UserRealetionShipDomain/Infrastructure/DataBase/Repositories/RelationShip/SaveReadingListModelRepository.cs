...
{
    public class SaveReadingListModelRepository : CommonDbRepository<SaveReadingListModel, SaveReadingList>, ISaveReadingListRepository
    {
        public SaveReadingListModelRepository(AppDbContext _db, IMapper _mappper) : base(_db, _mappper)
        {
        }
    }
}
